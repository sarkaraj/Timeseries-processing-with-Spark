...
def _baseline_moving_average_row_to_rdd_map(line, **kwargs):
...
def _run_baseline_moving_average_weekly(test_data, sqlContext, **kwargs):
...
def _run_baseline_moving_average_monthly(test_data, sqlContext, **kwargs):
    MODEL_BLD_CURRENT_DATE = kwargs.get('MODEL_BLD_CURRENT_DATE')  # is of datetime.date type
