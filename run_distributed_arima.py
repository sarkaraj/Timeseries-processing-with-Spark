...
from transform_data.rdd_to_df import map_for_output_arima_weekly, arima_output_schema
...
#
# opt_arima_results_mapped = opt_arima_results_rdd.map(lambda line : map_for_output_arima_weekly(line))
#
